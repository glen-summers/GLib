	...
	private:
		std::ostream & WriteTo(std::ostream & s) const
		{
			Formatter::Format(s, "{{{0:%08X}-{1:%04X}-{2:%04X}-{3:%02X}{4:%02X}-{5:%02X}{6:%02X}{7:%02X}{8:%02X}{9:%02X}{10:%02X}}}", id.Data1,
												id.Data2, id.Data3, id.Data4[0], id.Data4[1], id.Data4[2], id.Data4[3], id.Data4[4], // NOLINT(magic-numbers)
												id.Data4[5], id.Data4[6],																														 // NOLINT(magic-numbers)
												id.Data4[7]);																																				 // NOLINT(magic-numbers)
			return s;
		}
